...
const SiegeView = dynamic(() => import("../components/Siege/SiegeView"), { ssr: false, loading: () => <div style={{ aspectRatio: "16 / 9", borderRadius: 14, background: "#140f0a", border: "1px solid rgba(240,166,58,0.18)", display: "flex", alignItems: "center", justifyContent: "center", color: "#a29a88", fontFamily: "'Cinzel', Georgia, serif", letterSpacing: "0.3em", fontSize: 12 }}>RAISING THE WALLS…</div> });
...
const SiegePage: NextPage = () => (
  <>
    ...
    <div style={{ minHeight: "100vh", background: "radial-gradient(ellipse at 50% 0%, #2a1c10 0%, #0e0905 65%)", color: "#e9e2d2", padding: "10px 10px 24px" }}>
